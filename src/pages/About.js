...
export default function About() {
  return (
    <div className="relative isolate overflow-hidden bg-white my-8 px-6 py-8 sm:py-32 lg:overflow-visible lg:px-0" id="about">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold leading-7 text-primary_">Transformando momentos especiales en recuerdos inolvidables</p>
            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <ul role="list" className="mt-4 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                  ...
                  <i className="text-primary_ fa-solid fa-chart-simple mt-2"></i>
                  <span>
                ...
                <li className="flex gap-x-3">
                <i className="text-primary_ fa-regular fa-handshake mt-2"></i>
                  <span>
