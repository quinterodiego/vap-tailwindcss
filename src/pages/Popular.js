    ...
    <div className='mt-16 bg-white flex-column py-20'>
      ...
      <div id="default-carousel" className="relative w-full" data-carousel="slide">
        ...
        <button type="button" className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
          <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-primary dark:bg-gray-800/30 group-hover:opacity-75 dark:group-hover:opacity-75 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
