...
import { fetchProdcutByIdAsync, selectedProductById } from '../productListSlice';
...
export default function ProductDetail() {
  ...
  useEffect(() => {
    dispatch(fetchProdcutByIdAsync(params.id))
  }, [dispatch, params.id])
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm font-medium hover:text-indigo-500" style={{ color: colorPrimary }} >
                    Size guide
                  </a>
                </div>
