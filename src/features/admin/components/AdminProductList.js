...
const sortOptions = [
  ...
  { title: 'Price: Low to High', sort: 'price', order: 'asc', current: false },
  { title: 'Price: High to Low', sort: 'price', order: 'desc', current: false },
]
          ...
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900">Todos los productos</h1>
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link to={'/admin/product-form'}>
                        <button className="rounded-md mx-8 px-3 py-2 my-5 text-sm font-semibold bg-primary text-white shadow-sm hover:hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Agregar Nuevo Producto</button>
                      </Link>
                    </div>
              ...
              <div key={i}>
                ...
                <div>
                  <Link to={`/admin/product-form/edit/${product.id}`}>
                    <button className="rounded-md px-3 py-2 my-5 text-sm font-semibold bg-primary text-white shadow-sm hover:hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Editar Producto</button>
                  </Link>
                </div>
              </div>
            ))}
